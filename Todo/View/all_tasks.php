    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?php
                    if($item['status'] != 1){
                        echo '<form class="done_form">
                        <input name="task_id" type="hidden" class="form-control task_id"
                            value="'.$item['id'].'" required />
                        <button type="submit" id="submit" class="btn btn-success done_btn">Done</button>
                    </form>';
                    }else{
                        echo '<svg xmlns="http://www.w3.org/2000/svg" style="color:green" width="30" height="30" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
